...
# First try simple import (same as synthetic test file)
ITAMED_L2_AVAILABLE = False
itamed_l2 = None
try:
    ...
    if hasattr(itamed_l2, 'itamed1d_l2'):
        ...
        print("✓ ITAMeD L2 version available (for smooth, broad peaks) - imported via simple import")
    else:
        print("⚠ ITAMeD L2 module imported but itamed1d_l2 function not found")
        itamed_l2 = None
except ImportError:
    # Fallback: Try to import from same directory as this script
    try:
        ...
        if l2_module_path.exists():
            ...
            if hasattr(itamed_l2, 'itamed1d_l2'):
                ITAMED_L2_AVAILABLE = True
                print("✓ ITAMeD L2 version available (for smooth, broad peaks) - loaded from file path")
            else:
